...
> 历史方案：本文对应早期的本地单品利润分析工具。当前功能以 [ERP 功能规划](erp-product-plan.md) 为准，实施采用 [Web ERP 技术方案](erp-technical-plan.md) 和 [开发执行计划](development-plan.md)。文件解析思路可继续参考，Streamlit 单机界面及原有里程碑不作为新 ERP 的既定技术决策。
